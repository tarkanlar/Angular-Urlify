    ...
    angular
        ...
        .filter('urlify', function  () {
            ...
            // ARABIC_MAP
            {
                ...
                'ض':'d', 'ط':'t', 'ظ':'th', 'ع':'aa', 'غ':'gh', 'ف':'f',
                'ق':'k', 'ك':'k', 'ل':'l', 'م':'m', 'ن':'n', 'ه':'h', 'و':'o',
                'ي':'y'
            }],
            Downcoder = {
                initialize: function() {
            ...
            downcode = function(text) {
                Downcoder.initialize();

                var downcoded = "",
                    pieces = text.match(Downcoder.regex);
            ...
            return function (text) {
                ...
                var removelist = [ "a", "an", "as", "at", "before", "but", "by",
                    "for", "from", "is", "in", "into", "like", "of", "off",
                    "on", "onto", "per", "since", "than", "the", "this", "that",
                    "to", "up", "via", "with"],

                    r = new RegExp('\\b(' + removelist.join('|') + ')\\b',
                        'gi');
